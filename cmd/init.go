...
var exampleInit = `
	...
	trendyos init --passwd your-server-password  \
...
var initCmd = &cobra.Command{
	...
	Long: `trendyos init --master 192.168.0.2 --master 192.168.0.3 --master 192.168.0.4 \
	--node 192.168.0.5 --user root --passwd your-server-password \
	--version v1.18.0 --pkg-url=/root/kube1.18.0.tar.gz`,
	Example: exampleInit,
